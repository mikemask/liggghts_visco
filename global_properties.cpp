...
{
  static const char * TIMESTEP_CREATE_BOND  = "timestepCreateBond";
  static const char * MAX_DISTANCE = "maxDistance";
  static const char * RADIUS_MULTIPLIER = "radiusMultiplier";
  static const char * Y_MAX_1 = "yMax1";
  static const char * Y_MAX_2 = "yMax2";
  static const char * Y_MAX_3 = "yMax3";
  static const char * Y_MAX_4 = "yMax4";
  static const char * Y_SPRING = "ySpring";
  static const char * MU_MAX_1 = "muMax1";
  static const char * MU_MAX_2 = "muMax2";
  static const char * MU_MAX_3 = "muMax3";
  static const char * MU_MAX_4 = "muMax4";
  ...
  ScalarProperty* createTimestepCreateBond(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* tsCreateScalar = createScalarProperty(registry, TIMESTEP_CREATE_BOND, caller);
    LAMMPS * lmp = registry.getLAMMPS();
    double tsCreate = tsCreateScalar->data;

    if(sanity_checks)
    {
      if(floor(tsCreate)!=tsCreate)
        lmp->error->all(FLERR,"timestep of bond creation must be an integer");
    }

    return tsCreateScalar;
  }

  ScalarProperty* createMaxDistance(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* maxDistScalar = createScalarProperty(registry, MAX_DISTANCE, caller);

    return maxDistScalar;
  }

  ScalarProperty* createRadiusMultiplier(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* radMultScalar = createScalarProperty(registry, RADIUS_MULTIPLIER, caller);

    return radMultScalar;
  }

  ScalarProperty* createYSpring(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* ySpringScalar = createScalarProperty(registry, Y_SPRING, caller);

    return ySpringScalar;
  }

  ScalarProperty* createYMax1(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* yMax1Scalar = createScalarProperty(registry, Y_MAX_1, caller);

    return yMax1Scalar;
  }

  ScalarProperty* createYMax2(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* yMax2Scalar = createScalarProperty(registry, Y_MAX_2, caller);

    return yMax2Scalar;
  }

  ScalarProperty* createYMax3(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* yMax3Scalar = createScalarProperty(registry, Y_MAX_3, caller);

    return yMax3Scalar;
  }

  ScalarProperty* createYMax4(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* yMax4Scalar = createScalarProperty(registry, Y_MAX_4, caller);

    return yMax4Scalar;
  }

  ScalarProperty* createMuMax1(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* muMax1Scalar = createScalarProperty(registry, MU_MAX_1, caller);

    return muMax1Scalar;
  }

  ScalarProperty* createMuMax2(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* muMax2Scalar = createScalarProperty(registry, MU_MAX_2, caller);

    return muMax2Scalar;
  }

  ScalarProperty* createMuMax3(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* muMax3Scalar = createScalarProperty(registry, MU_MAX_3, caller);

    return muMax3Scalar;
  }

  ScalarProperty* createMuMax4(PropertyRegistry & registry, const char * caller, bool sanity_checks)
  {
    ScalarProperty* muMax4Scalar = createScalarProperty(registry, MU_MAX_4, caller);
